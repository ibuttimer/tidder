...
public class StandardEvent_premod extends AbstractEvent<StandardEvent_premod, StandardEvent_premod.Event, StandardEvent_premod.EventMode>
                            implements ICommonEvents<StandardEvent_premod, Response> {
    ...
    private static StandardEvent_premod mFactoryInstance;
    ...
    public StandardEvent_premod(Event event) {
        super(event);
    }

    public StandardEvent_premod(Event event, @Nullable EventMode mode) {
        super(event, mode);
    }

    public static ICommonEvents<StandardEvent_premod, Response> getFactory() {
        if (mFactoryInstance == null) {
            mFactoryInstance = new StandardEvent_premod(Event.FACTORY_INSTANCE);
        }
        return mFactoryInstance;
    }

    @Override
    public ICommonEvents<StandardEvent_premod, Response> getFactoryInstance() {
        return getFactory();
    }
     ...
     * @return  event object
     */
    public static StandardEvent_premod newFollowingListRequest() {
        return new StandardEvent_premod(Event.FOLLOWING_LIST_REQUEST, EventMode.NEW_REQUEST);
    }
     ...
     * @return  event object
     */
    public static StandardEvent_premod newUpdateFollowingListRequest() {
        return new StandardEvent_premod(Event.FOLLOWING_LIST_REQUEST, EventMode.UPDATE_REQUEST);
    }
     ...
     * @return  event object
     */
    public static StandardEvent_premod newFollowingListRequest(ArrayList<Subreddit> list, int start, int end) {
        StandardEvent_premod event = new StandardEvent_premod(Event.QUERY_FOLLOW_STATUS_LIST_REQUEST);
     ...
     * @return  event object
     */
    public static StandardEvent_premod newPinnedListRequest() {
     ...
     * @return  event object
     */
    public static StandardEvent_premod newPinnedListRequest(String name) {
     ...
     * @return  event object
     */
    public static StandardEvent_premod newUpdatePinnedListRequest() {
     ...
     * @return  event object
     */
    public static StandardEvent_premod newUpdatePinnedListRequest(String name) {
     ...
     * @return  event object
     */
    private static StandardEvent_premod newPinnedListRequest(EventMode mode, String name) {
        StandardEvent_premod event = new StandardEvent_premod(Event.PINNED_LIST_REQUEST, mode);
     ...
     * @return  event object
     */
    public static StandardEvent_premod newSubredditInfoRequest(String name) {
        StandardEvent_premod event = new StandardEvent_premod(Event.SUBREDDIT_INFO_REQUEST);
        return event.setName(name);
    }
     ...
     * @return  event object
     */
    public static StandardEvent_premod newSettingsRequest() {
        return new StandardEvent_premod(Event.SETTINGS_REQUEST);
    }
     ...
     * @return  event object
     */
    public static StandardEvent_premod newSettingsResult() {
        return new StandardEvent_premod(Event.SETTINGS_RESULT);
    }
     ...
     */
    @Override
    @Nullable public StandardEvent_premod newResponseResult(Response response) {
        StandardEvent_premod event = null;
        Event type = null;
        if (response != null) {
        ...
        if (type != null) {
            event = new StandardEvent_premod(type);
    ...
    @Override
    @Nullable public <T extends ContentProviderResponse> StandardEvent_premod newCpResponseResult(T response) {
        StandardEvent_premod event = null;
        Event type = null;
        if (response != null) {
            Enum eType = response.getEventType();
    ...
    @Override
    protected StandardEvent_premod getThis() {
        return this;
    }
    ...
    public StandardEvent_premod setName(String name) {
        mParamMap.put(NAME_PARAM, name);
        return this;
    }

    public StandardEvent_premod setList(ArrayList<Subreddit> list) {
        mParamMap.put(LIST_PARAM, list);
        return this;
    }

    public StandardEvent_premod setStart(int start) {
        mParamMap.put(START_PARAM, start);
        return this;
    }

    public StandardEvent_premod setEnd(int end) {
    ...
    public static class AdditionalInfoBuilder
            extends
                AbstractEvent.AdditionalInfoBuilder<AdditionalInfoBuilder, StandardEvent_premod>
            implements
                IAdditionalInfoBuilder<AdditionalInfoBuilder> {

        public AdditionalInfoBuilder(StandardEvent_premod event) {
            super(event);
        }
    ...
    @Override
    public AdditionalInfoBuilder infoBuilder(@NonNull StandardEvent_premod event) {
        return new AdditionalInfoBuilder(event);
    }

    @Override
    @Nullable public Bundle additionalInfoTag(@NonNull StandardEvent_premod event) {
    ...
    @Override
    @Nullable public Bundle additionalInfoAll(@NonNull StandardEvent_premod event) {
        // additional info bundle for request
        return infoBuilder(event)
                .all()
                .build();
    ...
    public static class AdditionalInfoExtractor
            extends
                AbstractEvent.AdditionalInfoExtractor<AdditionalInfoExtractor, StandardEvent_premod, StandardEvent_premod.EventMode>
            implements
                IAdditionalInfoExtractor<StandardEvent_premod, AdditionalInfoExtractor> {

        public AdditionalInfoExtractor(StandardEvent_premod event, Bundle bundle) {
            super(event, bundle);
        }
    ...
    @Override
    public AdditionalInfoExtractor infoExtractor(@NonNull StandardEvent_premod event, @Nullable Bundle bundle) {
