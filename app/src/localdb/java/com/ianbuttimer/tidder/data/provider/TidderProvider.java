...
import com.ianbuttimer.tidder.data.db.PinnedColumns;
import com.ianbuttimer.tidder.data.db.TidderDatabase;
import com.ianbuttimer.tidder.data.provider.BaseProvider.Path;
...
import static com.ianbuttimer.tidder.data.provider.BaseProvider.TYPE_ITEM;
...
@ContentProvider(
        ...
        packageName = "com.ianbuttimer.tidder.data.db.gen"
)
